...
namespace VShop.ProductApi.Migrations
{
    ...
    public partial class SeedProducts : Migration
    {
        ...
        protected override void Up(MigrationBuilder mb)
        {
            ...
            mb.Sql("Insert Into Products(Name,Price,Description,Stock,ImageURL,CategoryId) Values('Clips',5.30,'Clips para papel',50,'clips1.jpg',2)");
        }

        /// <inheritdoc />
        // é um codigo que se der algum problema ele vai remover
